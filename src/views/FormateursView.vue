<template>
  ...
  >
    ...
    >
      ...
      >
        <h6 class="mb-0 font-bold capitalize">Gestion des Formateurs</h6>
    ...
    <div class="w-full px-2 py-2 mx-auto">
      <FormateursBodyVue></FormateursBodyVue>
      <footerVue></footerVue>
    </div>
    <!-- end cards -->
  </main>
...
import FormateursBodyVue from "../components/Formateurs/FormateursBody.vue";
...
export default {
  ...
  methods: {},
  methods: {},
  components: { sidebarVue, footerVue, FormateursBodyVue },
};
</script>
