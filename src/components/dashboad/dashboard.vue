<template>
  <div class="w-full px-6 py-6 mx-auto">
    ...
    <div class="flex flex-wrap -mx-3">
      ...
      <card>
        <template #titre> Utilisateurs </template>
        <template #data> 29 </template>
        <template #icon>
          <i class="leading-none fa fa-users text-lg relative top-3.5 text-white" aria-hidden="true">
          </i> </template
      ></card>
      <card>
        <template #titre> Parcours </template>
        <template #data> 1 </template>
        <template #icon>
          <i class=" fa fa-graduation-cap leading-none text-lg relative top-3.5 text-white" aria-hidden="true">
          </i> </template
      ></card> <card>
        <template #titre> Modules </template>
        <template #data> 25 </template>
        <template #icon>
          <i class="  leading-none fa fa-book  text-lg relative top-3.5 text-white" aria-hidden="true">
          </i> </template
      ></card> <card>
        <template #titre> Quizs </template>
        <template #data> 25 </template>
        <template #icon>
          <i class="  leading-none fa-solid fa-clipboard-question   text-lg relative top-3.5 text-white" aria-hidden="true">
          ...
          <div class="flex-auto p-4">
            <div class="flex flex-wrap -mx-3">
              ...
              >
                ...
                >
                  <img
                    src="./src/assets/img/shapes/waves-white.svg"
                  ...
                  <div class="relative flex items-center justify-center h-full">
                    <img
                      ...
                      src="./src/assets/img/illustrations/rocket-white.png"
                      alt="rocket"
                    />
                  </div>
                </div>
                  ...
                  <tr>
                    ...
                    >
                      <div class="flex px-2 py-1">
                        <div>
                          <img
                            src="./src/assets/img/small-logos/logo-xd.svg"
                  ...
                  <tr>
                    ...
                    >
                      <div class="flex px-2 py-1">
                        <div>
                          <img
                            src="./src/assets/img/small-logos/logo-atlassian.svg"
                            class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                            alt="atlassian"
                          />
                        </div>
                  ...
                  <tr>
                    ...
                    >
                      <div class="flex px-2 py-1">
                        <div>
                          <img
                            src="./src/assets/img/small-logos/logo-slack.svg"
                            class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                            alt="team7"
                          />
                        </div>
                  ...
                  <tr>
                    ...
                    >
                      <div class="flex px-2 py-1">
                        <div>
                          <img
                            src="./src/assets/img/small-logos/logo-jira.svg"
                            class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                            alt="jira"
                          />
                        </div>
                  ...
                  <tr>
                    ...
                    >
                      <div class="flex px-2 py-1">
                        <div>
                          <img
                            src="./src/assets/img/small-logos/logo-invision.svg"
                            class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-9 w-9 rounded-xl"
                            alt="invision"
                          />
                        </div>
